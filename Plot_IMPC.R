...
for (b in 1:3) {
  if (b == 1) {
    gamma <- 1 / (3.93 * (1:n)^{
      1.3
    }) # 3.93 was chosen such that sum of (gamma)_{i\in \mathbb{N}} approximately equals 1
  } else if (b == 2) {
    gamma <- 1 / (9.33 * (1:n)^{
      1.1
    }) # 9.33 was chosen such that sum of (gamma)_{i\in \mathbb{N}} approximately equals 1
  } else {
    gamma <- 1 / (13.48 * (1:n)^{
      1.05
    }) # 13.48 was chosen such that sum of (gamma)_{i\in \mathbb{N}} approximately equals 1
  }
