...
p_spending=ggplot(results_df, aes(seq.0.1..0.9..0.1.)) + 
  ...
  geom_line(aes(y = X2, linetype = "10",colour = "2")) + 
  geom_point(aes(y = X2,colour = "2")) +
  geom_line(aes(y = X2.1, linetype = "10",colour = "2"))+
  geom_point(aes(y = X2.1,colour = "2"))+
  geom_line(aes(y = X3, linetype = "25",colour = "2")) + 
  geom_point(aes(y = X3,colour = "2")) +
  geom_line(aes(y = X3.1, linetype = "25",colour = "2"))+
  geom_point(aes(y = X3.1,colour = "2"))+
  geom_line(aes(y = X4, linetype = "100",colour = "2")) + 
  geom_point(aes(y = X4,colour = "2")) +
  geom_line(aes(y = X4.1, linetype = "100",colour = "2"))+
  geom_point(aes(y = X4.1,colour = "2"))+
  geom_hline(yintercept=alpha)+
  scale_colour_manual(guide="none", values=c("1"="limegreen", "2"="#f84f4f"))+
  scale_linetype_manual(name  ="Batch-size", values = c("1"="solid","10"="longdash","25"="dashed","100"="dotted"))+
...
p_cSpending=ggplot(results_df_cSpending, aes(seq.0.1..0.9..0.1.)) + 
  ...
  geom_point(aes(y = X1.1),colour = "4")+
  geom_line(aes(y = X2, linetype = "10",colour = "4")) + 
  geom_point(aes(y = X2,colour = "4")) +
  geom_line(aes(y = X2.1, linetype = "10",colour = "4"))+
  geom_point(aes(y = X2.1,colour = "4"))+
  geom_line(aes(y = X3, linetype = "25",colour = "4")) + 
  geom_point(aes(y = X3,colour = "4")) +
  geom_line(aes(y = X3.1, linetype = "25",colour = "4"))+
  geom_point(aes(y = X3.1,colour = "4"))+
  geom_line(aes(y = X4, linetype = "100",colour = "4")) + 
  geom_point(aes(y = X4,colour = "4")) +
  geom_line(aes(y = X4.1, linetype = "100",colour = "4"))+
  geom_point(aes(y = X4.1,colour = "4"))+
  geom_hline(yintercept=alpha)+
...
ggsave("Plot_closedADDIS_consP_noAlph.png")
