...
p_spending=ggplot(results_df, aes(seq.0.1..0.9..0.1.)) + 
  ...
  scale_linetype_manual(name  ="Batch-size", values = c("1"="solid","2"="longdash","3"="dashed","4"="dotted"), labels=c("1","5","10", "25"))+
...
ggsave("Plot_closedADDIS_exP_lown_highmu.pdf")
